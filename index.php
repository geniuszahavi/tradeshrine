...
<!-- ===============>> Header section end here <<================= -->
 ...
 <!-- ===============>> About section start here <<================= -->
  ...
  <!-- ===============>> About section start here <<================= -->
  <section class="about padding-top--style2 padding-bottom ">
    <div class="container">
      <div class="about__wrapper">
        <div class="row g-5 align-items-center">
          <div class="col-lg-6">
         ...
         <div class="col-lg-6">
           <div class="about__content" data-aos="fade-left" data-aos-duration="800">
             <div class="about__content-inner">
               ...
               <p class="mb-0"> Tradeshrine is a leading provider of payment and trading solutions, as well as financial literacy education. We are committed to empowering users and broadening their financial knowledge so they can make informed decisions and manage their finances effectively. We also strive to bridge the gap between the rich and the poor by providing everyone with access to the tools and resources they need to succeed. </p>
         ...
         <div class="feature__content" data-aos="fade-right" data-aos-duration="800">
           <div class="feature__content-inner">
             <div class="section-header">
               <h2 class="mb-15 mt-minus-5"> <span>Why </span>Tradeshrine?</h2>
           ...
           <div class="roadmap__item-inner">
             <div class="roadmap__item-content">
               <div class="roadmap__item-header">
                 ...
                 <!-- <span>P4</span> -->
               <!-- </div>
               <p>Learn how to earn money by promoting  Tradeshrine products and services to others.</p>
             </div>
           </div>
               ...
               <div class="pricing__item-content">
                 ...
                 <div class="pricing__item-middle">
                   <ul class="pricing__list">
                     ...
                     <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                             class="dark"></span>
                             Online and offline trades (P2P) </li>
                     <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                               class="dark"></span>
                   ...
                   <ul class="pricing__list mb-5">
                     ...
                     <li class="pricing__list-item">  <div class="card " >
                       ...
                       <div class="card-body">
                             ...
                             <h3 class="mega line"> 6 Months</h3>
                 ...
                 <div class="accordion__item ">
                   <div class="accordion__header" id="faq1">
                     <button class="accordion__button" type="button" data-bs-toggle="collapse"
                       ...
                       <span class="accordion__button-content"> What is  Tradeshrine?</span>
                   ...
                   <div id="faqBody1" class="accordion-collapse collapse show" aria-labelledby="faq1"
                     ...
                     <div class="accordion__body">
                       <p class="mb-15 text-success">
                        Tradeshrine is a leading provider of payment and trading solutions, as well as trading and financial education. We are committed to empowering users and broadening their financial knowledge so they can make informed decisions and manage their finances effectively.
                       </p>
                     </div>
                   </div>
                 </div>
                 ...
                 <div class="accordion__item ">
                   <div class="accordion__header" id="faq2">
                     <button class="accordion__button collapsed" type="button" data-bs-toggle="collapse"
                       ...
                       <span class="accordion__button-content">What is the best way to get started with  Tradeshrine?</span>
                       <span class="accordion__button-plusicon"></span>
                     </button>
                   </div>
                   <div id="faqBody2" class="accordion-collapse collapse" aria-labelledby="faq2"
                     ...
                     <div class="accordion__body">
                       <p class="mb-15 text-success">
                         The best way to get started with  Tradeshrine is to sign up for a free account. Once you have a free account, you can browse our courses and services, and enroll in any course that you are interested in. You can also sign up for our signal group to receive premium trading signals.
                       </p>
                     </div>
                   </div>
                 </div>
