...
<!-- ===============>> Header section end here <<================= -->
  ...
  <section class="banner banner--style2  bg--cover"
   >
      ...
      <div class="banner__wrapper banner__wrapper--style2">
        <div class="row flex-md-row-reverse gx-5">
          <div class="col-lg-6 col-md-7">
            <div class="banner__content mt-5" data-aos="fade-left" data-aos-duration="1000">
             
                <h1 class="banner__content-heading">Learn to trade and succeed 
                  in the  <span>financial markets</span></h1>
                  <p class="banner__content-moto">Access comprehensive education on digital currency, trading, and more with our comprehensive courses and premium trading services
                  </p>
              <div class="btn-group">
          ...
          <div class="swiper-slide">
            <div class="partner__item">
              <div class="partner__item-inner">
                <img src="assets/images/partner/light/1.png" alt="partner logo" class="">
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="partner__item">
              <div class="partner__item-inner">
                <img src="assets/images/partner/light/2.png" alt="partner logo" class="">
              </div>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="partner__item">
              <div class="partner__item-inner">
                <img src="assets/images/partner/light/3.png" alt="partner logo" class="">
              </div>
            </div>
          </div>
          <!-- <div class="swiper-slide">
            <div class="partner__item">
              <div class="partner__item-inner">
                <img src="assets/images/partner/light/4.png" alt="partner logo" class="">
              </div>
            </div>
          </div> -->
          <!-- <div class="swiper-slide">
            <div class="partner__item">
              <div class="partner__item-inner">
                <img src="assets/images/partner/light/5.png" alt="partner logo" class="">
              </div>
            </div>
          </div> -->
        </div>
        ...
        <div class="row gx-5  gy-4 gy-sm-0  align-items-center">
          ...
          <div class="col-lg-6">
            <div class="about__content" data-aos="fade-left" data-aos-duration="800">
              <div class="about__content-inner">
                <h2>Convenient <span>Payments, Trading,</span>  and Financial Education for All </h2>

                <p class="mb-0">Bobis Resources is a leading provider of payment and trading solutions, as well as financial literacy education. We are committed to empowering users and broadening their financial knowledge so they can make informed decisions and manage their finances effectively. We also strive to bridge the gap between the rich and the poor by providing everyone with access to the tools and resources they need to succeed. </p>
            ...
            <div class="feature__content-inner">
              <div class="section-header">
                ...
                <p class="mb-0 text-success">
                  We are passionate about helping our users achieve their financial goals
                </p>
              </div>
                ...
                <div class="nav nav--feature flex-column nav-pills" id="feat-pills-tab" role="tablist"
                    ...
                    <div class="feature__item">
                      <div class="feature__item-inner">
                        <div class="feature__item-content">
                          <h6>Comprehensive financial education</h6>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="nav-link" id="feat-pills-four-tab" data-bs-toggle="pill"
                    ...
                    <div class="feature__item">
                      <div class="feature__item-inner">
                        <div class="feature__item-content">
                          <h6>Access to a variety of payment solutions</h6>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div class="service__item" data-aos="fade-up" data-aos-duration="1200">
            <div class="service__item-inner text-center">
              ...
              <div class="service__content">
                ...
                <p class="mb-0 text-success">We offer an affiliate program that allows users to earn commissions by referring their friends and family to Bobis Resources</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="roadmap__item roadmap__item--style2 ms-auto me-md-4 aos-init" data-aos="fade-right"
            ...
            <div class="roadmap__item-inner">
              <div class="roadmap__item-content">
                ...
                <p class="text-success">Learn how to earn money by promoting Bobis Resources products and services to others.</p>
              </div>
            </div>
            ...
            <div class="roadmap__item-inner">
              <div class="roadmap__item-content">
                <div class="roadmap__item-header">
                  ...
                  <!-- <span>P1</span> -->
                <!-- </div>
                <p>Learn the basics of digital currency, trading, and market analysis..</p>
              </div>
            </div>
            ...
            <div class="roadmap__item-inner">
              <div class="roadmap__item-content">
                <div class="roadmap__item-header">
                  ...
                  <!-- <span></span> -->
                <!-- </div>
                <p>Take your trading skills to the next level with in-depth courses on gift card trading, spot trading, futures trading, and more.</p>
              </div>
            </div>
            ...
            <div class="roadmap__item-inner">
              <div class="roadmap__item-content">
                <div class="roadmap__item-header">
                  ...
                  <!-- <span>P3</span> -->
                <!-- </div>
                <p>Get access to exclusive trading signals from a team of experienced traders.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="roadmap__item-inner">
              <div class="roadmap__item-content">
                <div class="roadmap__item-header">
                  ...
                  <!-- <span>P4</span> -->
                <!-- </div>
                <p>Learn how to earn money by promoting Bobis Resources products and services to others.</p>
              </div>
            </div>
            ...
            <div class="roadmap__item-inner">
              <div class="roadmap__item-content">
                <div class="roadmap__item-header">
                  ...
                  <!-- <span>P5</span> -->
                <!-- </div>
                <p>Learn how to become a crypto vendor or picker and earn money by helping others buy and sell cryptocurrencies.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="roadmap__item-inner">
              <div class="roadmap__item-content">
                <div class="roadmap__item-header">
                  ...
                  <!-- <span>P6</span> -->
                <!-- </div>
                <p>Learn how to trade cryptocurrencies directly with other users without using a centralized exchange.</p>
              </div>
            </div>
...
<!--                   
            ...
            <div class="pricing__item" data-aos="fade-right" data-aos-duration="1000">
              <div class="pricing__item-inner">
                <div class="pricing__item-content">
                  ...
                  <!-- pricing top part -->
                  <div class="pricing__item-top">
                    <h6 class="mb-15">Fundamentals Package</h6>
                    <h3 class="mb-25">$100/<span>1week to 1month</span> </h3>
                  </div>
                  ...
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                      ...
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                                    class="dark"></span>
                              	How to be a successful trader</li>    
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                                  class="dark"></span>
                                	How to create a trading offer/arrange your goods for buyers.</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                                    class="dark"></span>
                                    	How to calculate market rates</li>  
                  ...
                  <!-- pricing bottom part -->
                  <div class="pricing__item-bottom">
                    <a href="signup.php" class="trk-btn trk-btn--outline">Register</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="pricing__item " data-aos="fade-up" data-aos-duration="1000">
              <div class="pricing__item-inner active">
                <div class="pricing__item-content">
                  ...
                  <!-- pricing top part -->
                  <div class="pricing__item-top">
                    <h6 class="mb-15">Advanced Package</h6>
                    <h3 class="mb-25">$500/<span> Full Package</span> </h3>
                  </div>
                  ...
                  <div class="pricing__item-middle">
                    <ul class="pricing__list">
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                            class="dark"></span>
                            Gift card trading - $200</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                            class="dark"></span>
                            	Trading spot - $200</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                            class="dark"></span>
                            	Trading futures - $300</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                            class="dark"></span>
                            Becoming a lead or copy trader - $200</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                            class="dark"></span>
                          	How to use a signal to place a trade - $200</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                              class="dark"></span>
                          	Online and offline trades (P2P) - $250</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                                class="dark"></span>
                          	Using indications to trade - $200</li>
                      <li class="pricing__list-item"><span><img src="assets/images/icon/check.svg" alt="check"
                                  class="dark"></span>
                            Accurate trading signal ($100 per month)</li> 
                    </ul>
                  ...
                  <!-- pricing bottom part -->
                  <div class="pricing__item-bottom">
                    <a href="signup.php" class="trk-btn trk-btn--outline active">Register</a>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4" class="tall">
            <div class="pricing__item" data-aos="fade-left" data-aos-duration="1000">
              <div class="pricing__item-inner" style="height: 44rem;">
                <div class="pricing__item-content">

                  <!-- pricing top part -->
                  <div class="pricing__item-top">
                    <h6 class="mb-15">Trading Signal Group</h6>
                  <h3 class="pb-3">  <span>Package Options</span></h3>
                    <!-- <h3 class="mb-25">$50/<span>1 Month</span> </h3>
                    <h3 class="mb-25">$200/<span>6 Month</span> </h3>
                    <h3 class="mb-25">$300/<span>1 year</span> </h3> -->
                  </div>
                      ...
                      <li class="pricing__list-item" >
                        <div class="card " >
                          ...
                          <div class="card-body">
                              ...
                              <h3 class="mega line">$50 /<span class="ifiok"> 1 Month</span></h3>
                          </div>
                          <hr>
                        </div>
                   
                      <li class="pricing__list-item">  <div class="card " >
                        <div class="card-title"></div>
                        <div class="card-body">

                          
                              <h3 class="mega line">$200 /<span class="ifiok"> 6 Months</span></h3>
                      ...
                      <li class="pricing__list-item">
                        <div class="card ">
                          ...
                          <div class="card-body">
                            ...
                            <h3 class="mega">$300 /<span class="ifiok"> 1 Year</span></h3>
                  ...
                  <!-- pricing bottom part -->
                  <div class="pricing__item-bottom">
                    <a href="signup.php" class="trk-btn trk-btn--outline">Subscribe</a>
                  </div>
                </div>
              </div>
            </div>
 ...
 <section class="team padding-top padding-bottom bg-color">
  <div class="section-header section-header--max50">
    <h2 class="mb-15 mt-minus-5">M O <span>A</span></h2>
    <p>Our team of experienced and knowledgeable advisers who are passionate about helping others succeed.</p>
  </div>
  <div class="container">
...
<!-- ===============>> Team section start here <<==============-->
  ...
  <!-- ========== Roadmap Section start Here========== -->
    <!-- <section class="roadmap roadmap--style2 padding-top  padding-bottom bg-color">
      <div class="container">
        <div class="section-header section-header--max50">
          <h2 class="mb-15 mt-minus-5"> <span class="style2">Roadmap </span> of plarform</h2>
                      ...
                      <div class="roadmap__item">
                        <div class="roadmap__item-inner roadmap__item-inner--vertical-line-bottom">
                          ...
                          <div class="roadmap__item-date">
                            <span>Jan 01, 2023 - Jan 15, 2023</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="roadmap__item roadmap__item--reverse">
                        <div class="roadmap__item-inner roadmap__item-inner--vertical-line-top">
                          ...
                          <div class="roadmap__item-date">
                            <span>Jan 15, 2023 - Jan 30, 2023</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="roadmap__item">
                        <div class="roadmap__item-inner roadmap__item-inner--vertical-line-bottom">
                          ...
                          <div class="roadmap__item-date">
                            <span>Feb 01, 2023 - Feb 15, 2023</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="roadmap__item roadmap__item--reverse">
                        <div class="roadmap__item-inner roadmap__item-inner--vertical-line-top">
                          ...
                          <div class="roadmap__item-date">
                            <span>Feb 15, 2023 - Feb 28, 2023</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="swiper-slide">
                      <div class="roadmap__item">
                        <div class="roadmap__item-inner roadmap__item-inner--vertical-line-bottom">
                          ...
                          <div class="roadmap__item-date">
                            <span>Mar 1, 2023 - Mar 15, 2023</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="swiper-slide ">
                      <div class="roadmap__item roadmap__item--reverse">
                        <div class="roadmap__item-inner roadmap__item-inner--vertical-line-top">
                          ...
                          <div class="roadmap__item-date">
                            <span>Mar 15, 2023 - Mar 30, 2023</span>
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <div class="container">
      <div class="section-header d-md-flex align-items-center justify-content-between">
        <div class="section-header__content">
          <h2 class="mb-15"><span>Why</span> You Should Choose Us </h2>
                ...
                <div class="blog__item-inner">
                  ...
                  <div class="blog__content">
                    <div class="blog__meta">
                      <!-- <span class="blog__meta-tag blog__meta-tag--style1">Fore x trading</span> -->
                    </div>
                    <h5 class="10"> <a href="blog-details.html">	Our Courses: </a> </h5>

                    <p class="mb-15 text-white">We offer comprehensive and informative courses on a variety of financial topics.</p>
<!-- 
              ...
              <div class="blog__item blog__item--style2">
                <div class="blog__item-inner">
                  ...
                  <div class="blog__content">
                    ...
                    <h5 class="10"> <a href="blog-details.html">	Professional Team: </a> </h5>

                    <p class="mb-15 text-white">Our courses are taught by experienced professionals who are passionate about helping others succeed.</p>
              ...
              <div class="blog__item blog__item--style2">
                <div class="blog__item-inner">
                  ...
                  <div class="blog__content">
                    ...
                    <h5 class="10"> <a href="blog-details.html">	Customer Support:  </a> </h5>

                    <p class="mb-15 text-white">We are committed to providing our users with the tools and resources they need to achieve their financial goals.</p>
              ...
              <div class="blog__item blog__item--style2">
                <div class="blog__item-inner">
                  ...
                  <div class="blog__content">
                    ...
                    <h5 class="10"> <a href="blog-details.html">Trading Solutions: </a> </h5>

                    <p class="mb-15 text-white">We offer a variety of payment solutions to 
      ...
      <div class="text-center">
        <a href="blog-details.html" class="trk-btn trk-btn--border trk-btn--primary mt-40">View more </a>
      </div>
    </div>
                    ...
                    <div class="testimonial__footer">
                      <div class="testimonial__author">
                        ...
                        <div class="testimonial__author-designation">
                          <h6 class="text-success">Mobarok Hossain</h6>
                  ...
                  <div class="testimonial__item-content">
                    ...
                    <div class="testimonial__footer">
                      <div class="testimonial__author">
                        ...
                        <div class="testimonial__author-designation">
                          <h6 class="text-success">Guy Hawkins</h6>
                  ...
                  <div class="testimonial__item-content">
                    ...
                    <div class="testimonial__footer">
                      <div class="testimonial__author">
                        ...
                        <div class="testimonial__author-designation">
                          <h6 class="text-success">Belal Hossain</h6>
                  ...
                  <div class="accordion__item ">
                    <div class="accordion__header" id="faq1">
                      <button class="accordion__button" type="button" data-bs-toggle="collapse"
                        ...
                        <span class="accordion__button-content"> What is Bobis Resources?</span>
                    ...
                    <div id="faqBody1" class="accordion-collapse collapse show" aria-labelledby="faq1"
                      ...
                      <div class="accordion__body">
                        <p class="mb-15 text-success">
                        Bobis Resources is a leading provider of payment and trading solutions, as well as trading and financial education. We are committed to empowering users and broadening their financial knowledge so they can make informed decisions and manage their finances effectively.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion__item ">
                    <div class="accordion__header" id="faq2">
                      <button class="accordion__button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <span class="accordion__button-content">What is the best way to get started with Bobis Resources?</span>
                        <span class="accordion__button-plusicon"></span>
                      </button>
                    </div>
                    <div id="faqBody2" class="accordion-collapse collapse" aria-labelledby="faq2"
                      ...
                      <div class="accordion__body">
                        <p class="mb-15 text-success">
                          The best way to get started with Bobis Resources is to sign up for a free account. Once you have a free account, you can browse our courses and services, and enroll in any course that you are interested in. You can also sign up for our signal group to receive premium trading signals.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="accordion__item ">
                    <div class="accordion__header" id="faq3">
                      <button class="accordion__button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <span class="accordion__button-content"> What is the difference between the fundamentals and advance studies courses?</span>
                        <span class="accordion__button-plusicon"></span>
                      </button>
                    </div>
                    <div id="faqBody3" class="accordion-collapse collapse" aria-labelledby="faq3"
                      data-bs-parent="#faqAccordion1">
                      <div class="accordion__body">
                        <p class="mb-15 text-success"> The fundamentals courses are designed for beginners who are new to trading and financial markets. The advance studies courses are designed for more experienced traders who want to learn more about advanced trading strategies and techniques.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="accordion__item ">
                    <div class="accordion__header" id="faq4">
                      <button class="accordion__button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <span class="accordion__button-content">Do I need to enroll in all of the advance studies courses?</span>
                        <span class="accordion__button-plusicon"></span>
                      </button>
                    </div>
                    <div id="faqBody4" class="accordion-collapse collapse" aria-labelledby="faq4"
                      data-bs-parent="#faqAccordion1">
                      <div class="accordion__body">
                        <p class="mb-15 text-success"> No, you do not need to enroll in all of the advance studies courses. You can choose to enroll in the courses that are most relevant to your interests and trading goals.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="accordion__item ">
                    <div class="accordion__header" id="faq5">
                      <button class="accordion__button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <span class="accordion__button-content">What is the P2P trading course?</span>
                        <span class="accordion__button-plusicon"></span>
                      </button>
                    </div>
                    <div id="faqBody5" class="accordion-collapse collapse" aria-labelledby="faq5"
                      data-bs-parent="#faqAccordion1">
                      <div class="accordion__body">
                        <p class="mb-15 text-success"> The P2P trading course teaches you how to trade with other users directly, without the need for an exchange.</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="accordion__item border-0">
                    <div class="accordion__header" id="faq6">
                      <button class="accordion__button collapsed" type="button" data-bs-toggle="collapse"
                        ...
                        <span class="accordion__button-content"> What is the signal group?</span>
                        <span class="accordion__button-plusicon"></span>
                      </button>
                    </div>
                    <div id="faqBody6" class="accordion-collapse collapse" aria-labelledby="faq6"
                      data-bs-parent="#faqAccordion1">
                      <div class="accordion__body">
                        <p class="mb-15 text-success">  The signal group is a premium service that provides you with access to accurate trading signals. These signals are generated by our team of experienced traders using a variety of technical and fundamental analysis tools.</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row gy-5 gx-4">
            <div class="col-md-6">
              <div class="footer__about">
                <a href="index-3.html" class="footer__about-logo"><img width="50" src="assets/images/logo/bobis.png"
                    alt="Logo"></a>
            ...
            <div>
              <ul class="social">
                <li class="social__item">
                  <a href="https://m.facebook.com/" class="social__link social__link--style22"><i class="fab fa-facebook-f"></i></a>
                </li>
                <li class="social__item">
                  <a href="https://instagram.com/mgbeahuruikeb?igshid=NGVhN2U2NjQ0Yg==" class="social__link social__link--style22 "><i class="fab fa-instagram"></i></a>
                </li>
                <li class="social__item">
                  <a href="#" class="social__link social__link--style22"><i class="fa-brands fa-linkedin-in"></i></a>
                </li>
                <li class="social__item">
                  <a href="https://www.youtube.com/@bobisresources751" class="social__link social__link--style22"><i class="fab fa-youtube"></i></a>
                </li>
                <li class="social__item">
                  <a href="https://twitter.com/MgbeahuruikeG?t=bymuLN1T-zeKv86R3i0x2w&s=09" class="social__link social__link--style22 "><i class="fab fa-twitter"></i></a>
                </li>
              </ul>
            </div>
          </div>
