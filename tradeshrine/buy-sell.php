        ...
        ***********************************-->
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="row d-none" id="to-trade-area">
					<div class="col-xl-8">
						<div class="row">
							<div class="col-xl-12">
								<div class="card bubles">
									<div class="card-body">
										<div class="buy-coin  bubles-down">
											<div>
												<h2>Buy & Sell Coins Instantly</h2>
													...
													<div class="sell-element">
														<form>
															<div class="sell-blance">
																<label class="form-label text-primary">Select coin to buy</label>
																...
																<div class="input-group">
                                                                    ...
                                                                    <span class="input-group-text"> <img src="images/coin.png" width="50" alt=""></span>
                                                            ...
                                                            <div class="sell-blance">
																<label class="form-label text-primary">Rate: 120</label>
																<div class="form-label blance"><span>Total:</span><p>$3,123.9</p></div>
															...
															<div class="text-center">
																<a href="exchange.html" class="btn btn-primary w-75">BUY <span id="buy-coinname"></span></a>
															</div>	
														</form>
													</div>	
				...
				<div class="row" id="pay-trade-area">
