          ...
          <div class="row gy-5 gx-4">
              ...
              <div class="footer__links">
                ...
                <div class="footer__links-content">
                  <ul class="footer__linklist">
                    ...
                    <li class="footer__linklist-item"> <a href="service.php">Services</a> </li>
            ...
            <div class="col-md-2 col-sm-4 col-6">
              <div class="footer__links">
                ...
                <div class="footer__links-content">
                  <ul class="footer__linklist">
                    <li class="footer__linklist-item"> <a href="terms.php">	Terms of Service</a>
                    </li>
                   
                    <li class="footer__linklist-item"> <a href="#">	FAQs</a></li>
                    <li class="footer__linklist-item"> <a href="#">	Support Cente</a> </li>
                  </ul>
                </div>
              </div>
