          ...
          <div class="col-lg-6">
            <div class="about__content" data-aos="fade-left" data-aos-duration="800">
              <div class="about__content-inner">
                <h2 class="text-success">Convenient<span> Payments, Trading,</span>  and Financial Education for All </h2>

                <p class="mb-0">We are on a mission to build the most convenient payment and trading platform with the simple aim of empowering our users and also broadening their financial literacy for proper financial usage and management,as well as bridging the gap between the excessive rich and excessive poor. </p>
  ...
  <section class="roadmap roadmap--style1 padding-top  padding-bottom bg-color" id="roadmap">
    <div class="container">
      <div class="section-header section-header--max50">
        <h2 class="mb-15 mt-minus-5">Our  <span> Services</span></h2>
        <p class="flip">We offer the best trading services to enthusiasts, investors and future traders.</p>
      </div>
              ...
              <div class="roadmap__item-inner">
                <div class="roadmap__item-content">
                  <div class="roadmap__item-header">
                    <h3 class="text-success">	Trading Academy</h3>
                    <!-- <span>P1</span> -->
                  </div>
                  <p class="text-success">Our Trading Academy offers a variety of fundamental and advanced courses on various trading topics.</p>
                </div>
              </div>
          ...
          <div class="col-md-6">
            <div class="roadmap__item roadmap__item--style2 ms-auto me-md-4 aos-init aos-animate" data-aos="fade-right"
              ...
              <div class="roadmap__item-inner">
                <div class="roadmap__item-content">
                  <div class="roadmap__item-header">
                    <h3 class="text-success">Payment solutions</h3>
                    <!-- <span>P2</span> -->
                  </div>
                  <p class="flip text-success">We offer a variety of payment solutions, including gift card trading and peer-to-peer (P2P) trading.</p>
                </div>
              </div>
          ...
          <div class="col-md-6 offset-md-6">
            <div class="roadmap__item ms-md-4 aos-init" data-aos="fade-left" data-aos-duration="800">
              <div class="roadmap__item-inner">
                <div class="roadmap__item-content">
                  <div class="roadmap__item-header">
                    <h3 class="text-success">	Financial literacy education</h3>
                    <!-- <span>P3</span> -->
                  </div>
                  <p class="flip text-success">We also offer courses on becoming a marketer through affiliate earning programs and becoming a crypto vendor/picker for international transactions.</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="roadmap__item roadmap__item--style2 ms-auto me-md-4 aos-init" data-aos="fade-right"
              ...
              <div class="roadmap__item-inner">
                <div class="roadmap__item-content">
                  <div class="roadmap__item-header">
                    <h3 class="text-success">Trading signals</h3>
                    <!-- <span>P4</span> -->
                  </div>
                  <p class="flip text-success">We offer a premium trading signal service that provides users with timely and accurate trading signals</p>
                </div>
              </div>
          ...
          <div class="col-md-6 offset-md-6">
            <div class="roadmap__item ms-md-4 aos-init" data-aos="fade-left" data-aos-duration="800">
              <div class="roadmap__item-inner">
                <div class="roadmap__item-content">
                  <div class="roadmap__item-header">
                    <h3 class="text-success">	Affiliate program</h3>
                    <!-- <span>P5</span> -->
                  </div>
                  <p class="flip text-success">We offer an affiliate program that allows users to earn commissions by referring their friends and family to Bobis Resources.</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="roadmap__item roadmap__item--style2 ms-auto me-md-4 aos-init" data-aos="fade-right"
              ...
              <div class="roadmap__item-inner">
                <div class="roadmap__item-content">
                  <div class="roadmap__item-header">
                    <h3 class="text-success">	Crypto vendor/crypto remittance services</h3>
                    <!-- <span>P6</span> -->
                  </div>
                  <p class="flip text-success" >We offer crypto vendor/picker services for international transactions</p>
                </div>
              </div>
